...
// Charing Curve config command lengths
#define CMD_LENGTH_CURVE_CC 0xB0
#define CMD_LENGTH_CURVE_CV 0xB1
#define CMD_LENGTH_CURVE_FV 0xB2
#define CMD_LENGTH_CURVE_TC 0xB3
#define CMD_LENGTH_CURVE_CONFIG 0xB4
#define CMD_LENGTH_CURVE_CC_TIMEOUT 0xB5
#define CMD_LENGTH_CURVE_CV_TIMEOUT 0xB6
#define CMD_LENGTH_CURVE_FLOAT_TIMEOUT 0xB7
#define CMD_LENGTH_CHG_STATUS 0xB8
